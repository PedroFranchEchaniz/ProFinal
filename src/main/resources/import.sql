...
insert into cliente (id, apellidos, ciudad, contrasenia, correo_electronico, cp, direccion, dni, fecha_nacimiento, nombre, provincia, telefono) values (1, 'Franch', 'Sevilla', 'merendolA.4', 'pedrofe.av@gmail.com', '21130', 'C/STA Ma de la Rábida', '49107200S', '1991-06-24', 'Pedro', 'Sevilla', '666066874');
